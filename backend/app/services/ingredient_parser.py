...
DESCRIPTORS = {
    ...
    "whole", "ground", "crushed", "grated", "shredded", "julienned",
    "thinly", "finely", "roughly", "coarsely", "peeled", "seeded",
    "cored", "trimmed", "rinsed", "drained", "packed", "loosely",
    "firmly", "lightly", "softened", "melted", "room", "temperature",
    "cold", "warm", "hot", "frozen", "thawed", "cubed", "halved",
    "quartered", "torn", "crumbled", "divided", "optional", "to",
    "taste", "plus", "more", "extra", "about", "approximately",
    "heaping", "scant", "level", "generous", "small", "medium",
    "large", "thin", "thick", "boneless", "skinless", "unsalted",
    "salted", "low-sodium", "reduced-fat", "fat-free", "organic",
    "raw", "cooked", "uncooked", "prepared", "store-bought", "homemade",
}
...
def is_section_header(ingredient_str: str) -> bool:
    ...
    if re.match(r"^for\s+(the\s+)?", text):
        return True
    if text.endswith(":"):
        return True
    if re.match(r"^(sauce|filling|topping|garnish|serving|marinade|dressing|glaze|crust|base|assembly):?$", text):
        return True
...
COMMON_UNITS = {
    ...
    "liter", "milliliter", "pint", "quart", "gallon", "clove", "piece",
    "slice", "can", "package", "bunch", "head", "stalk", "sprig", "pinch",
    "dash", "handful", "medium", "large", "small",
}
